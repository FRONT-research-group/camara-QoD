...
- **QOS_E**: Up to 3 Mbps download/upload bandwidth for video applications
- **QOS_S**: Up to 10 Mbps download/upload bandwidth for video applications  
- **QOS_M**: Up to 20 Mbps download/upload bandwidth for video applications
- **QOS_L**: Up to 40 Mbps download/upload bandwidth for audio applications
